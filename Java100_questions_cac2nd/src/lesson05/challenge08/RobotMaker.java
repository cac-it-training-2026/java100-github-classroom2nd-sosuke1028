...
class Robot {
	...
	public void makeEggDishes(int eggNum, int butterNum, int flourNum, int sugarNum) {
		this.eggNum = eggNum;
		this.butterNum = butterNum;
		...
		if (flourNum % 170 == 0 && sugarNum % 50 == 0 && butterNum % 80 == 0) {
			System.out.println(flourNum / 170 + "個のクッキーが出来ました。");

		} else if (judge == 0.4) {
			System.out.println(eggNum / 2 + "人分のオムレツを作成しました。");
		} else if (eggNum % 1 == 0 && flourNum == 0 && sugarNum % 50 == 0 && butterNum % 80 == 0) {
			System.out.println(eggNum + "個のゆで卵が出来ました。");

		} else {
			System.out.println("何も出来ません。");
			System.out.println("正しい分量を選択してください");
		}
	}
...
public class RobotMaker {
	...
	public static void main(String[] args) throws IOException {
		...
		robot.makeEggDishes(eggNum, butterNum, flourNum, sugarNum);
